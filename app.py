...
id_dev = '1e0acfc6-1f47-4ff9-aba7-4300f6b9fa71'
...
client_telemetry_topic = id_dev + '/telemetry'
server_command_topic = id_dev + '/commands'
client_name = id_dev + 'nightlight_server'
